...
if (sellmenu == 1)
{
    ...
    {
        if (value[(i * 2)] != 0)
            draw_text(30, (130 + (i * 20)), string_hash_to_newline((s_value[(i * 2)] + "G - Ninechara")))
        if (value[((i * 2) + 1)] != 0)
            draw_text(170, (130 + (i * 20)), string_hash_to_newline((s_value[((i * 2) + 1)] + "G - Ninechara")))
    }
...
if (sellmenu == 2)
{
    ...
    draw_set_color(c_white)
    scr_setfont(fnt_maintext)
    draw_text(55, 150, string_hash_to_newline((("Really sell Ninechara for " + string(value[sellpos])) + "G?")))
    draw_text(80, 180, string_hash_to_newline("Yes"))
