...
{
    td = 1
    t1 = instance_create(text_x, (__view_get(1, 0) + 20), obj_creditsword)
...
if ((x > 0) && (td == 1))
{
    t2 = instance_create(text_x, (__view_get(1, 0) + 120), obj_creditsword)
...
{
    if (t3.y > (__view_get(1, 0) + 84))
        t3.y = (__view_get(1, 0) + 84)
}
if (con == 3)
{
