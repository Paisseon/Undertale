...
col = collision_line(((x - (cos(tideal) * r)) + ((-sin(tideal)) * r)), ((y + (sin(tideal) * r)) + ((-cos(tideal)) * r)), ((x + ((-cos(tideal)) * r)) + (sin(tideal) * r)), ((y + (sin(tideal) * r)) + (cos(tideal) * r)), obj_blockbullet, 0, 1)
if (col != -4)
    event_user(4)
