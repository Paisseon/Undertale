if (bordercon == 0)
{
    ...
    draw_rectangle(cbx1, cby1, (cbx2 + 4), (cby1 + 4), 0)
    draw_rectangle(cbx1, cby2, (cbx2 + 4), (cby2 + 4), 0)
    draw_rectangle(cbx1, cby1, (cbx1 + 4), (cby2 + 4), 0)
    draw_rectangle(cbx2, cby1, (cbx2 + 4), (cby2 + 4), 0)
