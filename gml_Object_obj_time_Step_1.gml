...
left = 0
right = 0
if ossafe_keyboard_check(vk_up)
    try_up = 1
if ossafe_keyboard_check_released(vk_up)
    try_up = 0
if ossafe_keyboard_check(vk_down)
    try_down = 1
if ossafe_keyboard_check_released(vk_down)
    try_down = 0
if ossafe_keyboard_check(vk_right)
    try_right = 1
if ossafe_keyboard_check_released(vk_right)
    try_right = 0
if ossafe_keyboard_check(vk_left)
    try_left = 1
if ossafe_keyboard_check_released(vk_left)
    try_left = 0
...
{
    if try_up
        up = ossafe_keyboard_check(vk_up)
    if try_down
        down = ossafe_keyboard_check(vk_down)
    if try_left
        left = ossafe_keyboard_check(vk_left)
    if try_right
        right = ossafe_keyboard_check(vk_right)
}
if ossafe_keyboard_check_released(vk_up)
    up = 0
if ossafe_keyboard_check_released(vk_down)
