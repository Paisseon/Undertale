...
if (con == 45)
{
    blk = instance_create((__view_get(0, 0) - 2), -2, obj_npc_marker)
...
if (con == 53)
{
    with (blk)
        instance_destroy()
    snd_play(snd_bell)
    shadow = instance_create(__view_get(0, 0), 0, obj_npc_marker)
...
if ((con == 56) && (instance_exists(OBJ_WRITER) == 0))
{
    ...
    dball = instance_create((__view_get(0, 0) + 60), -30, obj_discoball)
...
{
    repeat (2)
        instance_create((__view_get(0, 0) + random(320)), (__view_get(1, 0) - 10), obj_confetti)
...
if (con == 60)
{
    conf = instance_create((obj_mainchara.x + random(20)), (__view_get(1, 0) - 10), obj_confetti)
