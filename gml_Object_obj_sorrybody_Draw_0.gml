...
if (back == 1)
{
    ...
    if (tailtype == 1)
    {
        ...
        if (abs(rot) < 58)
        {
            ...
            if collision_line(x, ((y + 42) - (add * 15)), (x + lengthdir_x((130 + (60 * add)), (rot - 90))), (((y + 42) - (add * 15)) + lengthdir_y((130 + (60 * add)), (rot - 90))), obj_heart, 0, 1)
                event_user(1)
            if collision_line((x - 2), ((y + 42) - (add * 15)), ((x + lengthdir_x((130 + (60 * add)), (rot - 90))) - 2), (((y + 42) - (add * 15)) + lengthdir_y((130 + (60 * add)), (rot - 90))), obj_heart, 0, 1)
                event_user(1)
            if collision_line((x + 2), ((y + 42) - (add * 15)), ((x + lengthdir_x((130 + (60 * add)), (rot - 90))) + 2), (((y + 42) - (add * 15)) + lengthdir_y((130 + (60 * add)), (rot - 90))), obj_heart, 0, 1)
                event_user(1)
            madech = 0
