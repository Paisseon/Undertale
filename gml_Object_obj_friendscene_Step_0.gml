...
if (con == 25)
{
    und.face = spr_sparebt_bandage_ja
    global.typer = 81
...
if ((con == 26) && instance_exists(OBJ_WRITER))
{
    if (OBJ_WRITER.stringno == 1)
    {
        und.face = spr_savebt_ja
        asg.face = spr_fightbt_hollow_ja
    }
}
...
{
    if (OBJ_WRITER.stringno == 2)
        al.face = spr_savebt_ja
    if (OBJ_WRITER.stringno == 3)
        al.face = spr_sparebt_bandage_ja
}
...
{
    if (OBJ_WRITER.stringno == 1)
        pap.face = spr_introlast
    if (OBJ_WRITER.stringno == 3)
        pap.face = spr_undertaletitle
}
if ((con == 40) && (instance_exists(obj_blconwideslave) == 0))
{
    pap.face = spr_introimage
    global.typer = 8
...
{
    if (OBJ_WRITER.stringno == 1)
        pap.face = spr_fightbt_hollow
    if (OBJ_WRITER.stringno == 2)
        pap.face = spr_fightbt
    if (OBJ_WRITER.stringno == 3)
        pap.face = spr_fightbt_ja
}
...
{
    und.face = spr_sparebt
    asg.face = spr_itembt
    al.face = spr_savebt
    sans.face = spr_fightbt_hollow
    global.typer = 8
    global.faceemotion = 6
...
{
    global.typer = 80
    sans.face = spr_fightbt_hollow_ja
...
{
    asg.face = spr_itembt_ja
    al.face = spr_savebt_ja
    und.face = spr_talkbt_ja
    global.typer = 8
...
{
    if (OBJ_WRITER.stringno == 1)
        pap.face = spr_fightbt_hollow_ja
}
...
{
    if (OBJ_WRITER.stringno == 1)
        al.face = spr_itembt_ja
    if (OBJ_WRITER.stringno == 4)
        und.face = spr_itembt_hollow_ja
    if (OBJ_WRITER.stringno == 5)
    {
        al.face = spr_sparebt_bandage
        und.face = spr_sparebt
    }
...
{
    sans.face = spr_undertaletitle
    pap.face = spr_undertaletitle
    asg.face = spr_undertaletitle
    al.face = spr_undertaletitle
    und.face = spr_undertaletitle
    sidecon = 1
    global.typer = 8
    global.faceemotion = 0
