...
ossafe_fill_rectangle((__view_get(0, view_current) + 16), (__view_get(1, view_current) + 6), (__view_get(0, view_current) + 304), (__view_get(1, view_current) + 32))
draw_set_color(c_black)
ossafe_fill_rectangle((__view_get(0, view_current) + 19), (__view_get(1, view_current) + 9), (__view_get(0, view_current) + 301), (__view_get(1, view_current) + 29))
