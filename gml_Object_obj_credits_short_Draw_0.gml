...
if (number == 10)
{
    ...
    yy += 10
    draw_set_color(c_yellow)
    draw_text(xx, yy, string_hash_to_newline(scr_gettext("credits_short_mconv")))
    yy += 18
    draw_set_color(c_white)
    scr_credits_short_draw_name((xx + 30), yy, scr_gettext("credits_short_mconv_a"))
    yy += 10
    scr_setfont(fnt_ja_maintext)
}
if (won >= 1)
