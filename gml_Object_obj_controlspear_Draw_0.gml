...
if (active == true)
{
    ...
    ossafe_fill_rectangle((__view_get(0, view_current) + 16), (__view_get(1, view_current) + 180), (__view_get(0, view_current) + 304), (__view_get(1, view_current) + 235))
    draw_set_color(c_black)
    ossafe_fill_rectangle((__view_get(0, view_current) + 19), (__view_get(1, view_current) + 183), (__view_get(0, view_current) + 301), (__view_get(1, view_current) + 232))
    draw_set_color(c_white)
