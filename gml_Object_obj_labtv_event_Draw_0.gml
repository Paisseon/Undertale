...
if ((con == 2) && (instance_exists(OBJ_WRITER) == 0))
{
    ...
    draw_text((__view_get(0, 0) + 50), (__view_get(1, 0) + 15), string_hash_to_newline(scr_gettext("labtv_cancel")))
    draw_text((__view_get(0, 0) + 160), (__view_get(1, 0) + 15), string_hash_to_newline(scr_gettext("labtv_tape1")))
    draw_text((__view_get(0, 0) + 50), (__view_get(1, 0) + 35), string_hash_to_newline(scr_gettext("labtv_tape2")))
    draw_text((__view_get(0, 0) + 160), (__view_get(1, 0) + 35), string_hash_to_newline(scr_gettext("labtv_tape3")))
    draw_text((__view_get(0, 0) + 50), (__view_get(1, 0) + 55), string_hash_to_newline(scr_gettext("labtv_tape4")))
    draw_text((__view_get(0, 0) + 160), (__view_get(1, 0) + 55), string_hash_to_newline(scr_gettext("labtv_tape5")))
    draw_sprite(spr_heartsmall, 0, ((__view_get(0, 0) + 30) + (heartx * 110)), ((__view_get(1, 0) + 20) + (20 * hearty)))
    if (buffer < 0)
    {
