...
if (con >= 3)
{
    for (i = 0; i < 5; i += 1)
    {
        ...
        if collision_rectangle(global.idealborder[0], ((global.idealborder[2] + 9) + (i * 30)), ((global.idealborder[0] + myx) - 30), ((global.idealborder[2] + 18) + (i * 30)), obj_heart, 0, 1)
            event_user(11)
        if (collision_line(((global.idealborder[0] + myx) - 30), ((global.idealborder[2] + 9) + (i * 30)), ((global.idealborder[0] + myx) - 8), ((global.idealborder[2] + 9) + (i * 30)), obj_heart, 0, 1) || collision_line(((global.idealborder[0] + myx) - 30), ((global.idealborder[2] + 23) + (i * 30)), ((global.idealborder[0] + myx) - 8), ((global.idealborder[2] + 9) + (i * 30)), obj_heart, 0, 1))
            event_user(11)
    }
}
