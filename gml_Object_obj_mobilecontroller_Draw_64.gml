...
draw_sprite_ext(spr_joybase, 0, jx, jy, 3, 3, 0, joybase_colour, global.controller_opacity)
draw_sprite_ext(spr_joystick, 0, x, y, 3, 3, 0, joystick_colour, global.controller_opacity)
if dzdraw
{
    draw_set_alpha(0.5)
