...
if (weather != 3)
{
    ...
    draw_text_transformed(300, 10, string_hash_to_newline(scr_gettext("joyconfig_title")), 2, 2, 0)
...
if (weather == 1)
{
    ...
    draw_text_transformed((220 + sin((siner / 12))), (120 + cos((siner / 12))), string_hash_to_newline(scr_gettext("joyconfig_test_winter")), 1, 1, -20)
}
if (weather == 2)
{
    c = instance_create(0, 0, obj_ct_fallobj)
    ...
    draw_set_color(c_gray)
    draw_text_transformed((220 + sin((siner / 12))), (120 + cos((siner / 12))), string_hash_to_newline(scr_gettext("joyconfig_test_spring")), 1, 1, -20)
}
if (weather == 3)
{
    extreme2 += 1
    ...
    draw_set_color(c_gray)
    draw_text_transformed((220 + sin((siner / 12))), (120 + cos((siner / 12))), string_hash_to_newline(scr_gettext("joyconfig_test_summer")), 1, 1, -20)
}
if (weather == 4)
{
    c = instance_create(0, 0, obj_ct_fallobj)
    ...
    draw_set_color(c_gray)
    draw_text_transformed((220 + sin((siner / 12))), (120 + cos((siner / 12))), string_hash_to_newline(scr_gettext("joyconfig_test_fall")), 1, 1, -20)
}
if (intro == 1)
{
    if (rectile == 16)
